...
library(randomForest) # for carryingo out random forest
...
fit_knn <- knn3(train_x, as.factor(train_y), k=3) #if you don't do as.factor(train_y) you will get y needs to be a factor error
```
...
confusionMatrix(y_hat_knn, factor(test_y))  #if you want to check just the accuracy then add $overall["Accuracy"] to the end of this code
